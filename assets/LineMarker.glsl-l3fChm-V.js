import{Cu as X,DW as Z,DX as ee,Cx as te,Cv as ie,DY as re,DZ as ae,CC as o,DP as se,D9 as oe,DO as ne,CB as w,D_ as ce,D$ as le,Cy as pe,CA as de,CD as he,Dy as ve,CF as ue,E0 as F,E1 as N,E2 as me,E3 as fe,Dd as ge,bT as Se,CG as Pe,CH as ye,_ as _e,CI as M,CJ as U,CK as we,CL as R,CM as L,Df as ze,CO as xe,CP as $e,CQ as Ce,CS as b,CT as De,E4 as be,E5 as I,E6 as B,E7 as Te,E8 as Ve,E9 as Oe,CU as ke,e as p,CV as d,bQ as We,Dg as Me,Ea as q,oy as Le,DG as je,j8 as Ee,C_ as Ae,aJ as J,vW as Fe,cJ as G,aU as H,Eb as Ne}from"./index-B9VIL3e7.js";function Q(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
